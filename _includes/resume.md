...
## Technical Skills
* **Cloud & Infrastructure:** AWS (EKS, EC2, CloudFront), GCP (Compute Engine, Dataflow, Pub/Sub), On-Premise (K3s, Windows Server, Ubuntu/Linux Administration)
* **Automation & CI/CD:** Ansible, Jenkins, GitHub Actions, GitLab CI, AWS CodePipeline, UiPath
* **IaC & Orchestration:** Terraform, Terragrunt, Helm, Docker
* **Software Engineering:** Python (Django, Flask), PHP, Bash, Ruby on Rails
* **Web Servers & Edge:** Nginx, Apache, AWS WAF, GCP Cloud Armor, ngrok, Akamai CDN, Varnish Cache
...
* **Operational Excellence:** Modernized IaC by implementing Terragrunt across 50+ Terraform modules. Built CI/CD pipelines via AWS CodeBuild and GitHub Actions. Installed and configured UiPath RPA tools on Windows Server, optimizing PowerShell scripts and leveraging Windows Task Scheduler to orchestrate automated workflows.
...
* **Performance Efficiency:** Managed Akamai CDN, Varnish Cache, and Nginx reverse proxies for high-availability video streaming exceeding 200,000 RPS.
